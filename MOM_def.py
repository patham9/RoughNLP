...
Selfworld="nars"
#simple replacements
Replacements=[('that','and'),('but','and'),(' in ','_in '),(' at ','_at '),(' left ','_left '),(' right','_right '),(' above','_above '),(' below','_below '),(' on','_on ')] #is-prepositions as verbs
...
('(much|many|would|actually|immediately|that|the|a|an|to|of|inside|onto|can)$', 'IRRELEVANTFORNOW'),
('(not|doesn\'t)$', 'ZOT'), #not..
